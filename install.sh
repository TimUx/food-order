...
#   wget -qO- https://raw.githubusercontent.com/TimUx/FestSchmiede/v2.0.0/install.sh | bash
#
...
#   FESTSCHMIEDE_VERSION              – Release-Tag (Standard: 2.0.0)
...
FESTSCHMIEDE_VERSION="${FESTSCHMIEDE_VERSION:-2.0.0}"
