...
#   wget -qO- https://raw.githubusercontent.com/TimUx/FestSchmiede/v2.3.8/install.sh | bash
#
...
#   FESTSCHMIEDE_VERSION              – Release-Tag (Standard: 2.3.8)
...
FESTSCHMIEDE_VERSION="${FESTSCHMIEDE_VERSION:-2.3.8}"
