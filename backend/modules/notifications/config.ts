...
export const notificationsConfigSchema = z.object({
  ...
  smtp: channelEnabledSchema.extend({
    ...
    source: z.enum(['tenant', 'platform']).default('tenant'),
  }).default({ enabled: false, port: 587, useTls: true, source: 'tenant' }),
  branding: z.object({
    senderName: z.string().optional(),
...
export const defaultNotificationConfig: NotificationConfig = {
  ...
  smtp: { enabled: false, port: 587, secure: false, useTls: true, source: 'tenant' },
